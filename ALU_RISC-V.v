module ALU_RISCV(result,operand1,operand2,alu_opcode,flag);
...
always @(*) begin
        ...
        case(alu_opcode)
                ...
                3'b101: res = flag ? ($signed(operand1) < $signed(operand2)) ? 32'b1 : 32'b0 : (operand1 < operand2) ? 32'b1 : 32'b0 ; // SLT
